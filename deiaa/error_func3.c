...
/**
 * repeated_char - cnts the repetitions of a char
 *
 * @in: string input
 * @x: index
 * Return: repetitions
...
/**
 * err_sep_op - finds syntax errs
 *
 * @in: string input
 * @x: index
 * @lst: the last read character
 * Return: err index and 0 in case of no
 * errs
 */
...
/**
 * print_syntax_err - prints when a syntax err is found
 *
...
/**
 * check_syntax_error - inter. function to
 * print syn. error
 *
 * @datash: data structure
 * @in: string as input
